-- Ensure ticket history logging can always write and capture user context

BEGIN;

-- Make user_id nullable to avoid failures when auth context is missing
ALTER TABLE ticket_history
  ALTER COLUMN user_id DROP NOT NULL;

-- Keep changes default to avoid NULL insert failures
ALTER TABLE ticket_history
